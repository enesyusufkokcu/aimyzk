<header class="antialiased">
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 shadow-md rounded-md">
        <div class="flex flex-wrap justify-between items-center">
            <button id="sidebarButton" class="block md:hidden">
            ...
            <div class="flex items-center lg:order-2">
                <!-- DARK MODE TOGGLE -->
                {{-- @if ($theme == 'light')
                    <form action="{{ route('settings.changeTheme') }}" method="POST">
                        @csrf
                ...
                <div class="relative">
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden dropdown absolute right-0 overflow-hidden z-50 my-4 w-96 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg"
                        ...
                        <div>
                            <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                                ...
                                <div class="pl-3 w-full">
                                    <div class="text-gray-500 font-normal text-sm mb-1.5">New message
                                        from <span class="font-semibold text-gray-900">Bonnie
                                            Green</span>:
                                        "Hey, what's up? All set for the presentation?"</div>
                                    <div class="text-xs font-medium text-primary-700">a few
                                        moments
                                        ago</div>
                                </div>
                            </a>
                            <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                                ...
                                <div class="pl-3 w-full">
                                    <div class="text-gray-500 font-normal text-sm mb-1.5"><span
                                            class="font-semibold text-gray-900">Jese leos</span> and
                                        <span class="font-medium text-gray-900">5 others</span> started
                                        following you.
                                    </div>
                                    <div class="text-xs font-medium text-primary-700">10 minutes
                                        ago
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-primary-700">44 minutes
                                        ago
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#" class="flex py-3 px-4 hover:bg-gray-100">
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-primary-700">3 hours ago
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="relative">
                    <button type="button" data-dropdown-toggle="apps-dropdown"
                        class="p-2 text-gray-500 rounded-lg drop-shadow-lg hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
                        <span class="sr-only">View notifications</span>
                        <!-- Icon -->
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden dropdown absolute right-0 overflow-hidden z-50 my-4 w-96 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg"
                        id="apps-dropdown">
                        <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50">
                            Apps
                        </div>
                        <div class="grid grid-cols-3 gap-4 p-4">
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 group">
                                <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500"
                ...
                <div class="relative">
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full object-cover"
                            src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : 'https://flowbite.com/docs/images/people/profile-picture-5.jpg' }}"
                            alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
                    <div class="hidden dropdown absolute right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg"
                        id="dropdown">
                        <div class="py-3 px-4">
                            <span
